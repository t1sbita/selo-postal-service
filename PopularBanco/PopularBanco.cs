...
namespace PopularBanco
{
    ...
    {
        public List<Cidade> PopularCidade()
        {
        ...
        public List<EntradaEndereco> PopularEntradaEndereco()
        {
            List<EntradaEndereco> lista = new List<EntradaEndereco>() {
                ...
                new EntradaEndereco("Fulano de Tal", "Rua dos Bobos", "0", "RB125Z4785", "Utopia", "Aleatoricity"),
                ...
                new EntradaEndereco("Beltrano Entrando", "Beco sem Saída", "123", "RB125Z4785", "Utopia", "Aleatoricity"),
                ...
                new EntradaEndereco("Luiz Lula", "Rua do Tribunal", "13", "VSPZCP0STX", "Bairro da Cana", "Cinquanta e Um"),
                new EntradaEndereco("Gon Freecss", "Rua Sem Fim", "10", "M8LCMIHNIX", "Ilha da Baleia", "Hunter"),
                new EntradaEndereco("Leonora", "Rua dos Corvos", "17", "O726G17J7O", "Bairro do Poente", "Londres"),
                new EntradaEndereco("Josilene Passos", "Rua Eliseu", "6", "X8LV4VTVUN", "Canela", "Feira de Santana"),
                new EntradaEndereco("Bolsonaro", "Rua Da Cloroquina", "17", "M3ZF9LC4CE", "Palácio do Planalto", "Brasilia"),
                new EntradaEndereco("Bill Gates", "Rua Dono da Microsoft", "98", "XP95NT7810", "Microsoft", "Vale do Silício"),
                ...
                new EntradaEndereco("Nome Qualquer", "Rua Embratel", "21", "RB125Z4785", "Setor das Antenas", "Aleatoricity"),
            };
